...
export default function Login() {
  ...
  return (
    <section className='w-full lg:h-screen
      ...
      <div className='flex flex-col align-middle w-8/12 md:w-5/12 my-20 mx-auto
        ...
        <div className='mb-10'>
          <Link to='/login/signup' className='mt-4 mb-1 text-sm underline text-gray-500
            block text-center hover:text-blue-500'>회원가입</Link>
          <Link to='/login/find' className='text-sm underline text-gray-500
            block text-center hover:text-blue-500'>아이디 또는 비밀번호를 잊어버리셨습니까?</Link>
        </div>
      </div>
    </section>
  )

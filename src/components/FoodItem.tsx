    ...
    border-b-2 mb-5'>
      <div className='select-none my-12 '>
        <div className='flex ml-4'>
          ...
          <h2 className='text-[3.2rem] font-bold font-main text-[#323e44]
            ml-3 w-5/6 border-b-4 border-[#536F7D]'>{data?.RECIPE_NM_KO}</h2>
        </div>
      ...
      <ul className='md:w-2/6 w-full md:my-12 my-4 flex justify-between md:block'>
        ...
        <li className='my-2 flex leading-10 text-[#536F7D]'>
          ...
          <p className='text-xl leading-10 font-subMain'>{data?.CALORIE}</p>
        </li>
        <li className='my-2 flex leading-10 text-[#536F7D]'>
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" 
            className="w-10 h-10 mr-4">
          ...
          <p className='text-xl leading-10 font-subMain'>{data?.COOKING_TIME}</p>
        </li>
        <li className='my-2 flex leading-10 text-[#536F7D]'>
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" 
            className="w-10 h-10 mr-4">
          ...
          <p className='text-xl leading-10 font-subMain'>{data?.LEVEL_NM}</p>
        </li>
        <li className='my-2 flex text-[#536F7D]'>
          ...
          <p className='text-xl leading-10 font-subMain'>{data?.QNT}</p>
        </li>
      </ul>

...
export default function FoodItem({idx} :{idx:number}) {
    ...
    <article className='h-full md:flex justify-between w-[85vw] mx-auto
          ...
          <h2 className='text-[3.2rem] font-bold font-main text-[#323e44]
            ml-3 w-5/6 border-b-4 border-[#536F7D]'>
              <span className='text-[2rem] italic
                font-main mb-3 ml-1 mr-5'>{idx}</span>
      ...
      <ul className='md:w-2/6 w-full md:my-12 my-4 flex justify-between md:block'>
        <li className='md:my-2 my-auto flex'>
          ...
          <span className='hidden md:block  my-auto text-sm mr-1'>{curData?.PC_NM}</span>
          {curData?.PC_NM && <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" 
